  ...
  try {
    ...
    try {
      ...
      const systemPrompt =
        ...
        "常见模式：存在性验证（mRNA发现→蛋白/组织证实）、功能赋予、状态锚定（在已知生物学轴上定位）、" +
        "机制深挖、干预验证（敲除/过表达/药物看结局）。\n\n" +
        "字段要求：\n" +
        "- closure：一句话概括全图逻辑闭环，常为'从X到Y，从Y到Z'，15-30字。\n" +
        "- layers[]：title（8-16字概括论证目的）、panels（panel字母数组）、purpose（这层干什么、与上层关系，30-80字）、" +
        ...
        '{"question":"可选refine版问句","closure":"…","layers":[{"title":"…","panels":["A","B"],"purpose":"…","panelDetails":[{"panel":"A","text":"…","relation":"递进"}],"conclusion":"→…"}],"bridge":"…"}';

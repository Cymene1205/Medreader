  ...
  try {
    ...
    try {
      ...
      const systemPrompt =
        ...
        "- layers[]：title（用 4-12 字的精炼短语概括这层的论证目的，例如'基线表型对比'/'关键通路验证'/'临床队列分析'，自由命名但需准确贴切）、" +
        "panels（panel字母数组）、purpose（这层干什么、与上层关系，30-80字）、" +
        ...
        '{"question":"可选refine版问句","closure":"…","layers":[{"title":"基线表型对比","panels":["A","B"],"purpose":"…","panelDetails":[{"panel":"A","text":"…","relation":"递进"}],"conclusion":"→…"}],"bridge":"…"}';
